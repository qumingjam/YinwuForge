...
public class AlloyForgeConfig {
    ...
    // 装备类型与属性映射
    private final Map<String, List<String>> equipmentTypeAttributes = new ConcurrentHashMap<>();

    // 属性名称映射
    private final Map<String, String> attributeNames = new ConcurrentHashMap<>();
