...
public class MaterialConfig {
    ...
    private final Map<String, ConcentratedMat> concentratedMaterials = new LinkedHashMap<>();
    private final Map<String, String> categoryEquipmentMap = new HashMap<>();
    private final Map<String, CategoryAdjuster> adjusterConfigs = new HashMap<>();
